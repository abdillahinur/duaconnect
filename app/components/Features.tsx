      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-600">Post your prayers and supplications for the community to support.</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <Heart className="h-12 w-12 text-green-600 mb-4" />
            <h3 className="text-xl font-bold mb-2">Support Others</h3>
            <p className="text-gray-600">Offer your prayers and words of encouragement to fellow Muslims.</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <Star className="h-12 w-12 text-green-600 mb-4" />
            <h3 className="text-xl font-bold mb-2">Daily Inspiration</h3>
            <p className="text-gray-600">Receive daily Quranic verses and hadith to inspire your day.</p>
          </div>
        </div>
      </div>
    </section>
